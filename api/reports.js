...
router.post('/reports/@me/:yearmonth', async (req, res) => {
    ...
    let prompt = `Imagine you're a financial advisor, help this user based on his expenses, give specific advice only for these expenses, the user cannot reply to you. Reply in english. ${req.user.name}: Please give me a feedback on how to improve my finance, these are my expenses for this month ${month}/${year}: `;
